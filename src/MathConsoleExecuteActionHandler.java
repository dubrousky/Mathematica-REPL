 ...
 * @author ilyas
 */
public class MathConsoleExecuteActionHandler {
    ...
    public MathConsoleExecuteActionHandler(ProcessHandler processHandler,
                                              Project project,
    ...
    public void runExecuteAction(final MathREPLConsole console,
        ...
        if (!"".equals(text.substring(offset).trim())) {
            ...
            final int indent = 1;//myIndentHelper.getIndent(project, ClojureFileType.CLOJURE_FILE_TYPE, node);
    ...
    private void execute(MathREPLConsole languageConsole,
